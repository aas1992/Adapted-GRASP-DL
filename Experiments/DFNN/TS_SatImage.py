...
import numpy as np
from Datasets.SatImage import dataset
...
inicio = time()
best_satimage, lista_melhores = TabuSearchForDFNN.tabu_search(36, 7, dataset_train, maxim=5, iter=10)
print("\nBest results for SatImage:")
for i in best_satimage:
  ...
  print("Testing...")
  train_acc, test_acc = TabuSearchForDFNN.test_model(i, 36, 7, dataset_train, dataset_test)
