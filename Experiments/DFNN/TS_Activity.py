...
import numpy as np
from Datasets.Activity import dataset
...
inicio = time()
best_activity, lista_melhores = TabuSearchForDFNN.tabu_search(533, 4, dataset_train, maxim=5, iter=10)
print("\nBest results for Activity Recognition Using WPM:")
for i in best_activity:
  ...
  print("Testing...")
  train_acc, test_acc = TabuSearchForDFNN.test_model(i, 533, 4, dataset_train, dataset_test)
