...
best_satimage, lista_melhores = AdaptedGRASPForDFNN.grasp(36, 7, dataset_train, maxim=5, iter=10)
...
for i in best_satimage:
  ...
  print("Testing...")
  train_acc, test_acc = AdaptedGRASPForDFNN.test_model(i, 36, 7, dataset_train, dataset_test)
