...
best_activity, lista_melhores = AdaptedGRASPForDFNN.grasp(533, 4, dataset_train, maxim=5, iter=10)
...
for i in best_activity:
  ...
  print("Testing...")
  train_acc, test_acc = AdaptedGRASPForDFNN.test_model(i, 533, 4, dataset_train, dataset_test)
