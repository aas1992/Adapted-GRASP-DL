...
best_mnist, lista_melhores = AdaptedGRASPForDFNN.grasp(784, 10, dataset_train, maxim=5, iter=10)
...
for i in best_mnist:
  ...
  print("Testing...")
  train_acc, test_acc = AdaptedGRASPForDFNN.test_model(i, 784, 10, dataset_train, dataset_test)
