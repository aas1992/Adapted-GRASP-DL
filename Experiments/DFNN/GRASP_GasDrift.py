...
best_gas, lista_melhores = AdaptedGRASPForDFNN.grasp(128, 6, dataset_train, maxim=5, iter=10)
...
for i in best_gas:
  ...
  print("Testing...")
  train_acc, test_acc = AdaptedGRASPForDFNN.test_model(i, 128, 6, dataset_train, dataset_test)
