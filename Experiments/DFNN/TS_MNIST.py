...
import numpy as np
from Datasets.MNIST import dataset
...
inicio = time()
best_mnist, lista_melhores = TabuSearchForDFNN.tabu_search(784, 10, dataset_train, maxim=5, iter=10)
print("\nBest results for MNIST:")
for i in best_mnist:
  ...
  print("Testing...")
  train_acc, test_acc = TabuSearchForDFNN.test_model(i, 784, 10, dataset_train, dataset_test)
