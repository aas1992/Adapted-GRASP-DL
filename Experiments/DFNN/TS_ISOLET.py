...
inicio = time()
best_isolet, lista_melhores = TabuSearchForDFNN.tabu_search(617, 26, dataset_train, maxim=5, iter=10)
...
for i in best_isolet:
  ...
  print("Testing...")
  train_acc, test_acc = TabuSearchForDFNN.test_model(i, 617, 26, dataset_train, dataset_test)
